...
from .Locations import all_locations, QUPlocation, rank_location_ids, rank_locations, level_location_ids, \
    ...
    combo_locations, combo_location_ids
...
class QUPworld(World):
    ...
    def create_regions(self) -> None:
        ...
        region.add_locations({ location: combo_location_ids[location] for location in combo_locations if location in self.all_locations })
        challenges = [0, 0, 0, 0]
